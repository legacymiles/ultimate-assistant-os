...
export const metadata = {
  title: "Dashboard · Ultimate Assistant OS",
  description:
    "Your private second brain. Folders you open like pages, one search box that reads inside your files, saved logins, and an agent that reorganises only with your confirmation.",
};
