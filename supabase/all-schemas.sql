...
--
-- Runs all three app schemas in one pass. Every statement is idempotent
-- (create ... if not exists / duplicate_object guards), so re-running this is
-- safe and is the intended way to apply later additions.
--
